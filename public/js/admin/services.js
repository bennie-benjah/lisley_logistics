...
class ServicesModule {
            ...
            serviceItem.innerHTML = `
                <div class="service-header">
                    ...
                    <div class="service-actions">
                        ...
                        <button class="btn-action btn-toggle" data-action="toggle" data-id="${
                            service.id
                        }"
                                title="${
                ...
                <div class="service-content">
                    ...
                    ${
                        ...
                        <div class="service-date">
                            <small><i class="far fa-calendar"></i> ${new Date(
                                service.created_at
    ...
    showEmptyGrid(message) {
        ...
        const addButton = servicesGrid.querySelector(
    ...
    filterServices(filter) {
        ...
        serviceItems.forEach((item) => {
            switch (filter) {
                ...
                case "inactive":
                    item.style.display =
                        item.getAttribute("data-status") === "inactive"
                            ? "block"
                            : "none";
                    break;
            }
    ...
    showServiceForm(service, title, isEdit) {
        ...
        <form id="serviceForm">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <select id="modalServiceIcon" class="form-control">
                        <option value="fas fa-plane" ${
                            service && service.icon === "fas fa-plane"
                                ? "selected"
                                : ""
                        }>Air Freight</option>
                        <option value="fas fa-ship" ${
                            service && service.icon === "fas fa-ship"
                                ? "selected"
                                : ""
                        }>Sea Freight</option>
                        <option value="fas fa-truck" ${
                            service && service.icon === "fas fa-truck"
                                ? "selected"
                                : ""
                        }>Road Freight</option>
                        <option value="fas fa-warehouse" ${
                            service && service.icon === "fas fa-warehouse"
                                ? "selected"
                                : ""
                        }>Warehousing</option>
                        <option value="fas fa-box" ${
                            service && service.icon === "fas fa-box"
                                ? "selected"
                                : ""
                        }>Packaging</option>
                        <option value="fas fa-passport" ${
                            service && service.icon === "fas fa-passport"
                                ? "selected"
                                : ""
                        }>Customs</option>
                        <option value="fas fa-satellite" ${
                            service && service.icon === "fas fa-satellite"
                                ? "selected"
                                : ""
                        }>Tracking</option>
                        <option value="fas fa-link" ${
                            service && service.icon === "fas fa-link"
                                ? "selected"
                                : ""
                        }>Supply Chain</option>
                        <option value="fas fa-globe" ${
                            service && service.icon === "fas fa-globe"
                                ? "selected"
                                : ""
                        }>Global</option>
                        <option value="fas fa-people-carry" ${
                            service && service.icon === "fas fa-people-carry"
                                ? "selected"
                                : ""
                        }>Logistics</option>
                    </select>
            ...
            <div class="form-group">
                ...
                <textarea id="modalServiceDescription" class="form-control" rows="4" required>${
    ...
    `;
        ...
        // Remove the showModal call - let admin.showModal handle the modal structure
        if (this.admin && this.admin.showModal) {
            this.admin.showModal(title, content, () =>
                this.handleServiceSubmit(isEdit, service?.id)
            );
        } else {
            // Fallback if admin.showModal doesn't exist
